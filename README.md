...
`TypeScript`를 활용한 안정적인 코드 작성과 팀의 개발 경험을 향상시키는 것에 관심이 많은 프론트엔드 개발자 우상욱입니다.

프론트엔드뿐만 아니라 백엔드, 인프라, 모바일 등 풀스택 영역에 대한 이해를 바탕으로 개발부터 배포까지 전체 프로세스를 고려한 개발을 추구합니다.

명확한 규칙 내에서 일하는 것을 좋아하고, 맡은 일은 책임감을 가지고 처리합니다.
